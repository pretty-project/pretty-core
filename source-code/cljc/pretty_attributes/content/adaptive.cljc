...
(ns pretty-attributes.content.adaptive)
...
(defn adaptive-text-height
  ...
  ; - The given 'line-height' value can be ...
  ...
  ; According to the 'pretty-attributes/presets/font.css' stylesheet, the default line-height/font-size ratio is 1.5.
